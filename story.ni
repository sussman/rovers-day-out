...
To say over:
	say "[quotation mark][paragraph break][quotation mark]".
...
7			shower			--						soap dispenser	"[The underling] produces a long, snaking device and feeds it into the ablative enamel injector port. After paying out several meters of tubing, [the underling] yanks back sharply on the device, and the tool makes a clicking sound. Suddenly, the tubing goes taught and the handle of the device is jerked out of [the underling]'s grasp. The tool is draw precipitously into the injector port, the handle smashing to pieces before the entire tool disappears into the wall. A grinding sound comes from the floor of the shower, and you sense a general failure in the ablative enamel injector. From [the underling] you hear a murmured [quotation mark]Uh oh. That's not right.[quotation mark][paragraph break]A voice breaks over the local radio circuit, [quotation mark]Assault ship to [underling]: Say again? What's not right?[over]Oh nothing. Nothing at all,[quotation mark] replies the flustered [underling]. [quotation mark]Everything's fine here. Thanks.[over]Roger that. Assault ship standing by.[quotation mark]"
8			shower			--					shampoo dispenser					"[The underling] removes a plate from the shower floor and pulls up rainbow-colored spaghetti of wires and optical cables. After carefully tracing them back to the solenoid pump, [the underling] produces some diagonal wire cutters and clips the red (snip), the green (snip), and the pair of blue (snip, snip) leads. There is again a rattling under the shower floor, followed by a sickly wheezing sound. Several seconds pass.[paragraph break]A transmission comes through on the local frequency, [quotation mark][assault ship designation] to [underling] aboard [if the ACU is an Enemy of Earth]enemy vessel [end if]Valkyrie.[over]Aye, Captain, [underling] here, over.[over]We're observing some venting of gas or smoke or something from the extruder ducts on the dorsal and lateral hulls.[over]Really? Well, I... I'm not sure what that's about, captain.[over]Acknowledged. Just wanted to remind you to be careful with the extruder systems. They can be might delicate, but they're worth a heap of cash.[over]Roger, captain. Will take due care.[quotation mark]. The [underling] selects a hefty sledge hammer and beats the floor just above the malfunctioning solenoid pump and then sweeps the broken shards behind a bulkhead."
9			shower			--						--					"After carefully cleaning the shower area, [the underling] sets off towards the engineering deck."
10			kitchen		--						--					"[The underling] carefully turns the corner into the kitchen and looks around. Extending the antenna of his radio to get through the heavy shielding on the engineering deck, [the underling] radios, [quotation mark][assault ship designation] from [underling]: Just checking in. I'm in the engineering section. No contacts.[over]Roger, [underling]. Telemetry is still five-by-five. [Assault ship designation] standing by.[quotation mark]"
...
13			kitchen		range					--					"[The underling] clambers over a bulkhead towards the cooking range. Before going any closer, he radios,[quotation mark]This is [underling] to [assault ship designation], over.[over][Assault ship designation]. Go, [underling].[over]I'm standing right next to the fusion chamber. I just want to be sure... this thing is definitely off, right? I mean, it looks powered down now, but I don't want to go in there, and ... you know.[over]Our scans show Valkyrie has no heavy helium. I repeat, the have no fusion fuel. You should be fine... if not, we're suiting up your backup. Over.[over]Right. Okay, thanks. I'm going in.[quotation mark] [The underling] runs into the fusion chamber, pulls the control unit out of the wall, the scene fades from your view. [The underling] re-emerges near the base of where the stove used to stand."
14			kitchen		drawer					--					"Waving a geiger counter ahead like a crucifix against vampires, [the underling] approaches the reactor core. The geiger counter is whistling like a kettle on full boil.[paragraph break][if the underling is the technician]The nervous technician clears his throat and speaks into his radio microphone, [quotation mark]Come in, [assault ship designation], this is space tech Ktumbe reporting.[over]Roger, go ahead.[over]The level of ionizing radiation is off the scale in here. Are you sure this radsuit is rated for going near that reactor core?[over]Should be, yeah. Hey -- you're still alive, right? Must be working.[over]I guess so. Okay, I'm going to pull the plug on this thing.[otherwise][quotation mark]This is maintenance and repair robot designation zed-alpha-four. I am proceeding with deactivation of the reactor core. Radiation levels are high. I recommend full rad-decon when I return to the [assault ship designation][end if][over]Roger that. This is [assault ship designation] standing by.[quotation mark][paragraph break][The underling] pulls the telemetry bud on the reactor controller and from your perspective, the kitchen drawer winks out of existence."
15			kitchen		--						--					"[The underling] moves quickly out of the kitchen, glad to be finished with the reactor core."
16			living room	--						--					"On the local band radio, you intercept, [quotation mark]This is [underling] to [assault ship designation].[over][Assault ship designation], [underling], copy.[over]Sir, I don't see any one here.[over]We told them to stay out of your way. They're probably hiding. Holded up in escape pods or something.[over]I don't think so sir. When I say nobody, I mean, I've been through just about the entire ship, nosecone to main thruster, and I see no one at all. And another thing -- there aren't any escape pods. Also, no galley, no barracks, nothing. This is a like a ghost ship. Creepy.[over]Get ahold of yourself, [underling]! Secure the cargo door and finish the memory dump, and we can all go home.[over]Aye sir. Almost done.[quotation mark]"
17			living room	--						front door		"[The underling] fiddles with the controls on the front door, and suddenly you realize that you have no can no longer feel the door. It is still there, but you can no longer open and close it.[paragraph break]This is [underling] reporting: Cargo bay door secured.[quotation mark]"
18			living room	--						picture			"[The underling] takes the picture of you, Rover and Tomasz off the wall and connects it to some device which flickers and beeps. When he puts it back on the wall, the picture is dark.[paragraph break][quotation mark]Moe's Gah! You wouldn't believe the data capacity of this thing -- and it's almost full![quotation mark] gushes [the underling].[paragraph break][quotation mark]Acknowledged, [underling], data stream is still being buffered over here. I think you've hit the mother load. You are authorized to return to [assault ship designation].[over]Roger, [assault ship designation], I'm on the way![quotation mark]"
