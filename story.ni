...
Instead of an animal barking:
	if Back on Mars is happening:
		...
		say "Forgetting his bone for a moment, Rover takes a big breath and lets out a mighty, [quotation mark]Woooooooof![quotation mark][paragraph break]The jagged, twisted space probe falls from his jaws, pinning David to the deck, and nearly slicing him in half. He expires instantly.[paragraph break]Rover takes a step back, the [quotation mark]Did I do something wrong?[quotation mark] expression playing across his face.";
		if David Venkatachalam is exposed:
			say "Janet stares blankly for a moment and then reaches up, and strokes the treads on Rover’s forward transaxle. [quotation mark]Good dog, Rover.[quotation mark]she says. [quotation mark]Good boy.[quotation mark]";
		otherwise:
			...
			otherwise:[worms are ready to rock]
				...
				if the player consents:
					if David Venkatachalam is in the Living Room:
						say "The voracious mutant eels are released throughout the ship. Neither David nor Janet make a sound, or at least none that you can hear above the ultrasonic chirping of the bloodthirsty eels.[paragraph break]You switch your video feed to the living room, but even in that interval, the eels have covered Janet and David in a glistening, writhing, slithering mass which almost immediately collapses to the floor and melts away.[if the front door is open][paragraph break]Before turning on each other, the eels at the edge of the frenzy detect the scent of more prey, and the mass of eels is out the front cargo bay door and down the boarding ramp before Janet's permalloy armband clatters metallically to the cargo bay floor.";
