...
Instead of searching the window when the player is self-aware during Real Thing:
	say "Through the viewer you can see nothing but swirling dust."
	
Instead of searching the window during Back on Mars:
	say "The external view shows the hangar in which Valyrie was originally constructed."
