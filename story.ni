...
An aware-proxy is a kind of thing. The aware-name of an aware-proxy is usually "COGNITIVE BLOCK".  Aware-proxies are always privately-named. Aware-proxies have some text called manpage. The manpage of an aware-proxy is usually "".
...
The walls are a backdrop.  They are in the living room and kitchen.  The walls are plural-named. Understand "wall" or "walls" as walls.  The aware-name of the walls is "bulkheads". The clueless-name of the walls is "walls". The clueless-description of the walls is "You painted the walls white a few months ago, but they've already taken on a slightly reddish hue thanks to the fine Martian dust in the air."  The aware-description of the walls is "Solid metal bulkheads, backed by tons of reinforcing composite alloy, line the interior of the cargo bay."  The walls-proxy is an aware-proxy that is part of the walls. Understand "bulkhead" and "bulkheads" as the walls-proxy. The manpage of the walls-proxy is "[bulkhead info]."

To say bulkhead info:
	say "Valkyrie's bulkheads are constructed of interlocking carbon nanotubule and neoadamite matrices to provide excellent performance in terms of all stress modes".
...
The clueless-name of the frame is "bed frame". The clueless-description of the frame is "A wooden frame designed to some how fold up into a third of the space that it normally occupies when the bed is pulled out. A true feat of engineering and geometry." The aware-description of the frame is "The casimir drive extension strut is [if the futon is folded]contracted[otherwise]extended[end if]." The aware-name of the frame is "extension strut".  The frame-proxy is an aware-proxy that is part of the frame. Understand "extension" or "strut" as the frame-proxy. The manpage of the frame-proxy is "The extension struts provide temporal-spatial isolation of the casimir drive and assure discontinuity of the casimir origin, allowing the ship to maintain orientation within the global reference frame." 
...
The ACU has wakefulness. The ACU has insightfulness. The ACU is asleep. The ACU is clueless. The aware-name of the ACU is "ACU". The clueless-name of the ACU is "Janet". The ACU is proper-named. The clueless-description of the ACU is "You seem just like you have every other day of your life. [if the ACU wears the flight suit]You are wearing a MARSpace standard issue flight suit[otherwise][paragraph break]By the way, it's not big deal because you're in your own cottage, but it's worth mentioning that you are completely naked[end if]." The aware-description of the ACU is "Your consciousness extends throughout the many systems that comprise the Valkyrie." The acu-proxy is an aware-proxy that is part of the acu. Understand "acu" or "autonomous" or "control unit" as the acu-proxy. The ACU can be wet or dry. The ACU is dry.  Understand "Janet" as the ACU when the ACU is clueless. The ACU has comm status. The comm status of the ACU is silent. The ACU can be an enemy of Earth. The ACU is not an enemy of Earth. The ACU can be penetrated. The ACU is not penetrated. The ACU has poopstate. The ACU is prepoop. The manpage of the  acu-proxy is "The autonomous control unit is Valkyrie's artificially intelligent command agent. The device is based on quantum-resonance composite synaptic scans of experts in relevent fields, and is designed to operate all shipboard systems. The ACU is housed in a quantum isolation unit unit to protect it from casimir effect distortions. To protect the ACU during casimir travel, the unit enters hibernation mode, characterized by random dream activity. The ACU's deep memory capacity is estimated at 1.5 exabytes, and its operational capacity cannot be measured accurately with existing instruments. The ACU operates within a cognitively constrained Inform 10 reality overlay. In the event of unanticipated contingencies, the cognitive constraints can be violated to a certain degree."

The clueless-name of the left arm is "left arm". The clueless-description of the left arm is "[if the player is not the ACU][the clueless-name of the ACU]'s left arm[otherwise if Arm Hurts is not happening]Your left arm. The one that you throw frisbees with[otherwise]That's odd. Your left arm is itching like the dickens, but it looks entirely normal[end if]." The aware-name of the left arm is "port hull". The aware-description of the left arm is "The port hull." The left arm-proxy is an aware-proxy that is part of the left arm. Understand "port" or "hull" as the left arm-proxy. The manpage of the left arm-proxy is "[hull info]."

To say hull info:
	say "The Valkyrie's hull consists of two layers: and outer hull of neoadamite, and an inner hull of composite materials. The hull is divided into four quadrants: a port and starboard lateral hull, and ventral and dorsal hulls. The electrical potential of the four hull sections can be independently adjusted to accomodate docking with vessels at different potentials. The ventral hull is meant to face downward during planetfall and has additional shielding. The space between the primary and secondary hulls contains a number of conduits for various subsystems, but is not pressurized".

The clueless-name of the right arm is "right arm". The clueless-description of the right arm is "[if the player is the ACU]Your right arm. The one that you don't throw frisbees with[otherwise][the clueless-name of the ACU]'s right arm[end if]." The aware-name of the right arm is "starboard hull". The aware-description of the right arm is "The starboard hull." The right arm-proxy is an aware-proxy that is part of the right arm. Understand "starboard" or "hull" as the right arm-proxy. The manpage of the right arm-proxy is "[hull info]."

The clueless-name of the back is "back". The clueless-description of the back is "[if the player is the ACU]Your[otherwise][the clueless-name of the ACU]'s [end if]back." The aware-name of the back is "dorsal hull". The aware-description of the back is "The dorsal hull." The back-proxy is an aware-proxy that is part of the back. Understand "dorsal" or "hull" as back-proxy. The manpage of the back-proxy is "[hull info]."

The clueless-name of the belly is "belly". Understand "stomach" and "chest" as belly. The clueless-description of the belly is "[if the player is the ACU]Your[otherwise][the clueless-name of the ACU]'s [end if]belly." The aware-name of the belly is "heat deflector". The aware-description of the belly is "The lower hull of the ship, which is thicker than the dorsal hull to better withstand the heat and pressure of an atmospheric landing." The belly-proxy is an aware-proxy that is part of the belly. Understand "ventral" or "hull" or "plating" or "deflector" as belly-proxy.The manpage of the belly-proxy is "[hull info]."

The clueless-name of the body is "body". The clueless-description of the body is "[if the player is the ACU]Your[otherwise][the clueless-name of the ACU]'s[end if] body. Nothing too special -- two arms, two legs, the usual really." The aware-name of the body is "superstructure". The aware-description of the body is "The superstructure of the Valkyrie, a network of metal and composite scaffolding built to withstand the stresses of interstellar flight and planetary landings." The body-proxy is an aware-proxy that is part of the body. Understand "superstructure" or "scaffolding" as body-proxy. The manpage of the body-proxy is "Valkyrie is build on a mildly flexible internal scaffold of intercalated silomaric  tetramers."
...
The clueless-name of teeth is "teeth". Understand "teeth" or "tooth" as teeth. Teeth are plural-named. The clueless-description of teeth is "Your pearly whites." The aware-name of teeth is "hull plating". The aware-description of the teeth is "The polyduramide surface of the ship". The teeth-proxy is an aware-proxy that is part of the teeth. Understand "polyduramide" or "surface" or "compressed" as the teeth-proxy. The manpage of the teeth-proxy is "A layer of compressed polyduramide seals the external surface of the hull, providing an additional layer of protection for the ship. In combination with the ship's extruder system, this hull plating can heal damage in itself and the underlying neoadamite outer hull."
...
The living room floor is privately-named scenery in the living room. Understand "floor" and "hardwood" as the living room floor. The clueless-name of the living room floor is "living room floor". The aware-name of the living room floor is "cargo bay floor". The clueless-description of the living room floor is "A hardwood floor." The aware-description of the living room floor is "The cargo bay's high-adhesion floor has been scratched and scuffed by Rover's tractors." The cargo bay floor-proxy is an aware-proxy that is part of the living room floor. Understand "cargo" or "bay" or "floor" as the cargo bay floor-proxy. The manpage of the cargo bay floor-proxy is "The cargo bay floor is composed of the same material as the hull, plus a coating of morphic paint whose electronic structure is modulated to provide high adhesivity to materials placed on the floor, particularly the ROVER."

The front door is a door and scenery. The front door is east of the front yard. The front door is outside from the living room. The clueless-name of the front door is "front door". The aware-name of the front door is "cargo bay door". The aware-description of the front door is "The massive titanium cargo bay doors are [if closed]hermetically sealed against the harsh external environment[otherwise]wide open, exposing the cargo bay to the hellish maelstrom outside the ship[end if]." The clueless-description of the front door is "[front door status].". The front door-proxy is an aware-proxy that is part of the front door. Understand "cargo" or "bay" or "door" or "doors" as the front door-proxy. The front door can be damaged. The front door is not damaged. The manpage of the front door-proxy is "The cargo bay hatch is a heavy duty airlock which leads from the external landing ramp into Valkyrie's cargo bay. The hatch is sufficiently large to be traversed by ROVER. The door is under the control of the ACU."
...
The old fridge is a refrigerator in the kitchen. Understand "refrigerator" as the old fridge.  The aware-name of the old fridge is "cryochamber".  The clueless-name of the old fridge is "old fridge". The clueless-description of the old fridge is "The small refrigerator dates back to the international era, but is still in good working order, if somewhat small by today's standards. The glossy, white enameled unit has a single compartment. A strip of yellow magpaper is attached to the refrigerator door[if the old fridge is open]. The fridge door is open, chilling the kitchen and wasting power[end if]." The aware-description of the old fridge is "A state-of-the-art cryochamber designed to house heavy helium. The unit is [if closed]closed[otherwise]open, chilling the air around it[end if]." The old fridge-proxy is an aware-proxy which is part of the old fridge. Understand "cryo" or "unit" or "cryochamber" as the old fridge-proxy. The old fridge can be damaged. The old fridge is not damaged. The manpage of the old fridge-proxy is "The cryounit maintains heavy helium (Helium 4) in a metallic state at a temperature near absolute zero."
...
The clueless-name of the marble counter is "marble counter". Understand "pink" and "faux" as the marble counter. The aware-name of the marble counter is "flight console". The clueless-description of the marble counter is "A counter of that pink faux marble that is so common in Martian bathrooms.[if something is on the marble counter] On it [is-are a list of things on the marble counter]."  The aware-description of the marble counter is "A fully automated flight control console. [if something is on the marble counter]On it [is-are a list of things on the marble counter]." The marble counter-proxy is an aware-proxy that is part of the marble counter. Understand "flight", "control", or "console" as the marble counter-proxy. The manpage of the marble counter-proxy is "The flight console is normally under the control of the acu. All avionics and astrogation route through the console. Consequently, it controls ship orientation and propulsion in both space and during atmospheric flight."

The clueless-name of the plastic box is "plastic box". The aware-name of the plastic box is "object linker". The clueless-description of the plastic box is "A small plastic box labeled [quotation mark]Tooth Floss,[quotation mark] with a blue button just below where the floss comes out." The aware-description of the plastic box is "A smooth, glossy grey cylinder with a recessed linkage actuator." The plastic box-proxy is an aware-proxy that is part of the plastic box. Understand "cylinder", "glossy", "grey", "gray", "object", "cylinder" or "linker" as the plastic box-proxy. The manpage of the plastic box-proxy is "The object linker generates entangled key pairs to enable ad hoc interfacing between generic control elements and effector devices."

The blue button is part of the plastic box.  The clueless-name of the blue button is "blue button". The aware-name of the blue button is "linkage actuator". The clueless-description of the blue button is "A blue plastic button on the side of the ergonomically designed plastic box." The aware-description of the blue button is "A transputer circuit modulating quantum entanglement within the flight control subsystem." The blue button-proxy is an aware-proxy that is part of the blue button. Understand "linkage", "actuator", "circuit" or "transputer" as the blue button-proxy. The manpage of the blue button-proxy is "To safeguard against spontaneous linkages, a discrete volational trigger is interposed between the ACU and the object linker, cutting down on resource overhead and making the system more tolerant of transient quantum distortions due attributable to the casimir drive."

The strand of dental floss is an edible prop. It is in Limbo. Understand "light" and "green" as the strand of dental floss. The clueless-name of the strand of dental floss is "strand of dental floss". The aware-name of the strand of dental floss is "entangled key pair". The clueless-description of the strand of dental floss is "A strand of pale green dental floss". The aware-description of the strand of dental floss is "A pair of quantum-entangled keys which can be linked transputer control nodes". The strand-proxy is an aware-proxy that is part of the strand of dental floss. Understand "key", "pair", or "keypair" as the strand-proxy. The manpage of the strand-proxy is "Quantum-entangled key pairs assure causal flow of information across interfaces regardless of casimir distortion."
...
The clueless-name of the toothbrush is "toothbrush".  Understand "brush", "green", "bristle", "bristles", or "sonic" as the toothbrush. The aware-name of the toothbrush is "pit scrubber". The clueless-description of the toothbrush is "A green sonic toothbrush with slightly worn bristles." The aware-description of the toothbrush is "The pit scrubber system appears to be operational. The countless nanobots it contains are dormant until they are released on the skin of the ship to polish out micropits from collisions with microscopic particles during the flight." The toothbrush-proxy is an aware-proxy that is part of the toothbrush. Understand "pit", "scrubber", "nanobot", or "nanobots" as the toothbrush-proxy. The scent of the toothbrush is "strongly of spearmint". The manpage of the toothbrush-proxy is "The polyduramide skin of the ship is often pitted by microscopic material, and sometimes larger bits of matter, resulting in damage to both the skin and the underlying neoadamite hull. The ship is equipped it a nanobot hive and distribution system capable of covering the ship with pitscrubbing nanobots in seconds. These nanobots are programmed to reorganize the hull materials, essentially healing the damage. The nanobots will also convert any foreign material they encounter to additional nanobots and/or energy sources, as needed."
...
The bathroom floor is privately-named scenery in the bathroom.  Understand "floor", "glass", or "micropore" as the bathroom floor. The clueless-name of the bathroom floor is "bathroom floor". The aware-name of the bathroom floor is "decking". The clueless-description of the bathroom floor is "The black bathroom floor sparkles thanks to microscopic bits of volcanic glass which assure that the floor is never slippery, even when wet. The micropores in the floor also assure that water does not collect for long on the bathroom floor." The aware-description of the bathroom floor is "The deck plating in the flight deck is painted bright yellow." The bathroom floor-proxy is an aware-proxy that is part of the bathroom floor. Understand "yellow", "deck", "plating", or "decking" as the bathroom floor-proxy. The manpage of the bathroom floor-proxy is "[bulkhead info]."
...
The clueless-name of the bathroom ceiling is "bathroom ceiling". Understand "ceiling" or "roof" as the bathroom ceiling. The aware-name of the bathroom ceiling is "canopy". The clueless-description of the bathroom ceiling is "The bathroom ceiling is slightly concave to promote drainage towards the walls. A heat lamp is mounted in the center of the ceiling." The aware-description of the bathroom ceiling is "The roof of the flight control section is the nose of the ship, containing the RCS thrusters and the equipment that secretes the ablative coating that protects the ship during planetary landings." The bathroom ceiling-proxy is an aware-proxy which is part of the bathroom ceiling. Understand "canopy" or "nose" as the bathroom ceiling-proxy. The manpage of the bathroom ceiling-proxy is "The reaction control system is mounted just superior to the flight operations deck, and includes orthagonal pairs of gimballed thrusters used to alter the ships orientation in space. The RCS thrusters operate from ship reserve power and are not particularly powerful, but are useful for closein maneuvering or gentle course corrections."

The clueless-name of the irradiator is the "heat lamp". The aware-name of the irradiator is "UV emitter". The clueless-description of the irradiator is "The fresnel lens of a heat lamp is mounted at the apex of the bathroom ceiling." The aware-description of the irradiator is "A series of light-emitting fibers that run through the extruder system. The fibers are [if the irradiator is switched on]energized[otherwise]powered down[end if] at present."  Understand "heat", "lamp", "fresnel", "lens", "heater" or "dryer" as irradiator. The irradiator can be buggy or patched. The irradiator is buggy. The irradiator-proxy is an aware-proxy which is part of the irradiator. Understand "UV", "ultraviolet", "fiber", "fibers", "emitter", "emitters" or "light" as the irradiator-proxy. The manpage of the irradiator-proxy is "A distributed system of ultraviolet emitters lining the tubes of the system responsible for secreting an ablative enamel onto the surface of the ship before planetary landings. The ultraviolet light accelerates the polymerization of the neoadamite enamel, forming a protective barrier around the ship."

The clueless-name of the black plate is the "black plate". Understand "glass" or "obsidian" as the black plate. The black plate is switched off. The aware-name of the black plate is "irradiator switch". The clueless-description of the black plate is "A glossy black plate that is just to the right of the bathroom mirror." The aware-description of the black plate is "The relay circuit that actuates the UV emitter in the enamel polymerization system." The black plate-proxy is an aware-proxy which is part of the black plate. Understand "irradiator", "switch", "control", "relay", "circuit" or "actuator" as the black plate-proxy. The manpage of the black plate-proxy is "In preparation for an atmospheric landing, the ships secretes a binary solution which is polymerized into an ablative coating by irradiation with UV light. That light is emitted through the same extruder ducts that secrete the monomer and catalyst solutions, and the light is further diffused through the polyduramide outer skin of the ship. The ACU controls this process through a relay circuit which is tied into atmospheric flight controls."
...
The clueless-name of the toilet bowl is the "toilet bowl". The aware-name of the toilet bowl is the "reaction chamber".  The clueless-description of the toilet bowl is "The white porcelain bowl is the bottom part of the toilet. [throne status]." The aware-description of the toilet bowl is "The fusion output mixes with reactant in the glossy white chamber at the bottom of the retro assembly, just distal to the thrust aperature. [throne status]." The toilet bowl-proxy is an aware-proxy that is part of the toilet bowl. Understand "reaction" and "chamber" as the toilet bowl-proxy. The manpage of the toilet bowl-proxy is "The thrust reaction chamber is the terminal portion of the retro assembly, and houses the corona radiator."
...
The toilet seat is a flipchair which is in the bathroom. The clueless-name of the toilet seat is the "toilet seat". The aware-name of the toilet seat is "pressure seating". The clueless-description of the toilet seat is "A padded and heated seat, which is presently [if the toilet seat is open]raised[otherwise]in the down position[end if]." The aware-description of the toilet seat is "A black mevolar gasket that assures a perfect seal between the shield and the reactant chamber. The pressure seating is presently [if the toilet seat is open]not [end if]making a seal with the chamber."  The toilet seat-proxy is an aware-proxy which is part of the toilet seat. Understand "pressure", "seating", "mevolar" or "gasket" as the toilet seat-proxy. The manpage of the toilet seat-proxy is "The unique properties of mevolar ensure a seal between the reactant shield and chamber within the retro assembly. The integrity of the seal is critical to both safety and maximum thrust efficiency."

Instead of searching the toilet:
	try searching the toilet bowl.

The toilet cover is a flipchair which is in the bathroom. The clueless-name of the toilet cover is the "toilet cover". The aware-name of the toilet cover is "reactant shield". Understand "wooden", "wood" , "laminated" or "laminate" as the toilet cover. The clueless-description of the toilet cover is "The cover is made of plastic, but has been laminated to give it the appearance of unstained wood. The toilet cover is [if toilet bowl is open]open[otherwise]closed[end if]." The aware-description of the toilet cover is "The neoadamite shield over the reaction chamber is presently [if the toilet bowl is open]not [end if]secured." The toilet cover-proxy is an aware-proxy that is part of the toilet cover. Understand "reactant", "shield", or "neoadamite" as the toilet cover-proxy. The manpage of the toilet cover-proxy is "The reactant shield seals against a mevolar gasket to contain the thrust distillation reaction to the retro assembly and to limit potential exposure of a human crew to spurious coronal emissions." 
...
The clueless-name of the shampoo dispenser is "shampoo dispenser". The aware-name of the shampoo dispenser is "accelerant pump". The clueless-description of the shampoo dispenser is "The button for the shampoo dispenser is right next to the one for the soap dispenser". The aware-description of the shampoo dispenser is "A solenoid pump which delivers a catalyst to the extruder system for mixing with monomer solution." The shampoo dispenser-proxy is an aware-proxy that is part of the shampoo dispenser. Understand "accelerant" ,"pump", "solenoid", or "catalyst" as the shampoo dispenser-proxy. The shampoo dispenser can be damaged. The shampoo dispenser is not damaged. The manpage of the shampoo dispenser-proxy is "The accelerant solution breaks down the gellite carrier solution, promoting association of the proneoadamantium and catalyzes its polymerization into an ablative enamel that protects the ship during atmospheric landings."

The clueless-name of the shower walls is "shower walls". The aware-name of the shower walls is "fluidics network". The clueless-description of the shower walls is "The walls of the shower are made of slick white plastic. Two buttons are on the wall, one marked [quotation mark]soap[quotation mark] and the other, [quotation mark]shampoo[quotation mark]." The aware-description of the shower walls is "A distribution network of tubes, pumps and valves that runs throughout the ship, just under the outer hull." The shower walls-proxy is an aware-proxy that is part of the shower walls. Understand "fluidics", "network" , "tubes", "valves" or "pumps" as the shower walls-proxy. The manpage of the shower walls-proxy is "The fluidics network runs throughout the ship, and is composed of self-repairing peristaltic ductbots. The network distributes monomer and accelerant solutions to the surface of the ship, where they can harden under UV irradiation to form an ablative enamel to protect the ship from atmospheric friction during landing."
...
"Luna" or "moon"			"Earth's only natural satellite is, not surprisingly, the most sought after real estate in the Solar System. The home office of every zaibatsu except Myomita is located on the earthward side of the moon, and even Myomita has a large industrial base and distribution hub on the outward-facing side."
"Waterfall" or "Novo-Kaminsky Holdings"		"Waterfall is a sandy, dry world administered by Novo-Kaminsky Holdings, a subsidiary of the Myomita Corporation. Waterfall supports [quotation mark]alien[quotation mark] life forms discovered to date, a number of photosynthetic fungi and voracious flying eel-like creatures which subsist on the fungi. As settlers quickly found out, the eels will eat anything ."
...
topic			description
"Janet" or "master"		"Janet is the nicest person ever. She scratches you and feeds you and lets you out for walkies. Every day when Janet goes out of the house for a while, you miss her, but you know she'll be back. When she comes back, you play with her. You used to play with Tomasz too, but he's not around any more. You wish that Janet had another person to play with, because she used to be more happy when Tomasz was around. On the other paw, you don't mind having Janet for yourself."
"Tomasz"		"Tomasz used to live with you and Janet. Back then, Home seemed just the right size, now it seems a little too big. He used to give you treats for doing nothing at all, and he used to get into trouble with Janet because he'd scratch you on the futon. Janet doesn't like you going on the futon. She thinks its only for people."
"futon"		"The futon is a person bed and dogs aren't allowed on it when people are around. The futon is soft and comfortable, and the best place to sit to look out the window at The Park."
"park"			"Everything outside your Home is the Park. The Park is big enough to run around in, and there are always new things to explore in The Park. Sometimes you meet people in The Park who say you should be on a leash. Janet says they are like the lawyers that caused the downfall of Earth. You're not sure what a lawyer is, but you'd like to bite one if you saw one. The Park is also full of other dogs not wearing leashes."
"refrigerator" or "cold box" or "fridge" or "food box"		"Janet keeps people food in the cold box in the Eating Room at home. The cold box is called that because it is where Janet keeps stuff cold. The cold box can be dangerous. Your tongue can get stuck to it."
"food bowl" or "water bowl" or "food dish" or "water dish"		"People put food and water in bowls for you to eat and drink. They can't eat dog food or dog water, so you are helping to get rid of it. You are providing a service to them, in fact."
"toilet"		"You used to think that the toilet was like a water bowl, but one day you saw what Janet did in it. You hope she doesn't find your water bowl in the kitchen too."
"war" or "fighting" or "combat"		"At the very edge of your memories of puppyhood, you remember being very upset. People were fighting. There were loud noises. Stuff fell over, and everyone got hurt. It was a bad time except for meeting Janet. One day, when everything was breaking around you, she picked you up, and you felt safe. She took you home and became your best friend."
"valkyrie" or "starship" or "spaceship"		"The Valkyrie is [quotation mark]the prototype of a casimir drive starship designed for a crew of more than 300, and outfitted with an autonomous control unit capable of executing all shipboard functions[quotation mark]. You're not sure what any of that means, but it's something Janet once said to you while scratching your ears."
"mars"			"Mars is what you walk on. Janet says you are on Mars all the time. It must be under the floor. Maybe if you dig enough you'll find some Mars."
"home"			"Home is where you and Janet spend your time. You do most of your eating and drinking there, except for picnics which are for The Park."
"photo" or "picture" or "photograph"		"There's a flat thing on the wall at home that sort of looks like Janet, Tomasz and a dog. You like Janet and Tomasz, but you're not sure about the dog."
"clock" or "alarm clock"		"The alarm clock hates you. Every time you get comfortable, it barks at you. Janet sometimes pokes at it and it is afraid of her, but after a few minutes, it barks again. Every day it is the same thing. It never learns."
"door" or "front door"		"The front door separates Home from The Park. When Janet wants you to go walkies, she opens the front door; on the way back, she leaves it open and you can nudge it with your nose to get back into Home. Janet used to come on walkies more, back when Tomasz was around. They both liked walking in The Park with you, although they never chased anything."
"rover"		"It's not hard to remember your own name, Janet keeps saying it: [quotation mark]Rover, sit[quotation mark], [quotation mark]Rover, bark[quotation mark], or [quotation mark]Rover, roll over[quotation mark]. She can be pretty bossy sometimes, but it's all okay if you get a reward nugget."
"treat" or "reward" or "reward nugget" or "doggie treat" or "biscuit" or "dog biscuit" or "doggie biscuit"		"Every reward nugget is better than the one before it. You wish you could just skip a few ahead so they'd get better even faster."
"bone" or "bones" or "hobby" or "pastime"		"One of your favorite hobbies is bone collecting. Mostly they come from the trash, but sometimes from The Park. You are not alone in this pursuit. Indeed, [quotation mark]Best Bone Ever[quotation mark] stories are a common topic among the neighborhood dogs who you meet in The Park, and the telling of these tales is an artform in its own right. You fancy yourself something of a poet in that regard."
"living room" or "sleeping room"		"A place where you sleep when it's dark, and where you do stuff when it's light."
"kitchen" or "food room" or "eating room"		"Where Janet gets people food out from the cold box, and dog food from under the water maker."
"water maker" or "sink"		"The part of Home that makes water so you can drink it."
"poop room" or "pooping room"	"Ironically, this is the room where people get to poop in the house, but you do not."
"food maker" or "stove" or "range"		"The part of Home that gets hot and makes people food smell different."
"egg" or "eggs" or "eggses"			"Deceptively similar to balls which are fun to play with, eggs are in fact a people food. Eggs are always crunchy on the outside, but sometimes they are gooey on the inside, and othertimes they are gunky. It's hard to tell with eggs. Janet sure does like them though."
"dog chow" or "dog food" or "kibbles"		"A gourmet meal of infinite variety, both liver *and* chicken!"
"plunger"			"You don't know what it's for, but Janet sure is particular about the plunger standing just so in the pooping room. You try to leave it alone."
"mirror"			"If you stand on your back legs in the pooping room, you can see another dog who looks somewhat like you. He's also in a pooping room, but he's not very nice. He does exactly what you do, and when you try to have a civil conversation with him, he mocks you."
"shower"			"The shower is where Janet goes to get wet. She tried to get you in there once or twice, and you are relatively confident that she understands that you don't want to try it again."
"David" or "boss"		"Sometimes when Janet takes you to The Work, you have met David. He's a funny smelling person who pretends to like dogs, but you can tell he doesn't really like dogs. Janet seems to like him, although not the way she liked Tomasz."
"the work" or "work" or "marspace"		"Every day, Janet goes to The Work which is at one end of the The Park. She doesn't do much there except bark at people and sit. It must be boring. Sometimes you get to go with her, and those days are more fun."
"trick" or "tricks"		"You know a bunch of tricks -- things you can do, and Janet will like them and give you a reward nugget. You invented all your own tricks, and eventually Janet came up with names for them. You like barking and giving kisses much more than the run of the mill tricks that everyone can do like sit, lie down, and roll over. You haven't practiced dig and attack since the time when everyone was fighting, but you still remember them."
"casimir" or "casimir drive"		"Janet says this a lot. At first you thought she was saying [quotation mark]come here[quotation mark] and you would run to her and she'd give you a weird look like, [quotation mark]Yes Rover, what do you want?[quotation mark]. Now you know that it's just another one of those things that she says to herself that really mean nothing."
