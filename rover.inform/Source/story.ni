...
The bathroom floor is privately-named scenery in the bathroom.  Understand "floor", "glass", "ground" or "micropore" as the bathroom floor. The clueless-name of the bathroom floor is "bathroom floor". The aware-name of the bathroom floor is "decking". The clueless-description of the bathroom floor is "The black bathroom floor sparkles thanks to microscopic bits of volcanic glass which assure that the floor is never slippery, even when wet. The micropores in the floor also assure that water does not collect for long on the bathroom floor." The aware-description of the bathroom floor is "The deck plating in the flight deck is painted bright yellow." The bathroom floor-proxy is an aware-proxy that is part of the bathroom floor. Understand "yellow", "deck", "plating", or "decking" as the bathroom floor-proxy. The scent of the bathroom floor is "damp, but not moldy". The texture of the bathroom floor is "like ultrafine pumice".
...
Some divets are scenery in the dug-up field. The printed name of the divets is "holes". Understand "hole", "holes", "excavation", or "excavations" as divets.  The description of the divets is "An apparently haphazard pattern of excavated holes in the ground. None of them are very impressive." The scent of the divets is "like the ground, just more so". The aware-name of the divets is "excavations". The texture of the divets is "not very deep".
...
The galley floor is a privately-named scenery in the eating room. The printed name of the galley floor is "floor". The clueless-name of the galley floor is "floor". Understand "ground" or "floor" or "linoleum" or "dirty" as the galley floor. The aware-name of the galley floor is "deck". The clueless-description of the galley floor is "Dirty linoleum." The scent of the galley floor is "like the third day of a hobo convention held in condemned box of cat litter". The texture of the galley floor is "the inside of a venus fly-trap, but stickier"
	...
	if the holder of Rover is the holder of the underling and damage counter is not greater than the number of rows in the Table of Underling Tasks:
		if Rover is in the location:
			...
			if a random chance of 1 in 2 succeeds:[split into two sections because of complexity]
				say "[one of] growls menancingly at [the underling][or] stalks behind [the underling], keeping a watchful eye on him[or] crouches and snarls, and [the underling] shrinks back. He continues his work slowly, keeping a wary eye on Rover[or] doesn't know what [the underling] is doing, but he knows he doesn't like it[or] sniffs [the underling] suspiciously[or] skulks around [the location in lower case], vigilantly keeping track of [the underling][or]'s fur stands on edge as he studies [the underling][or] howls at [the underling], who spins quickly, stumbling into the bulkhead[or] hovers just behind [the underling], sharpening his mining claws[or] grinds his tractors against the deck plating, momentarily distracting [the underling][in random order].";
			otherwise:
