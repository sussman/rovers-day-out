...
The water bowl is a bowl in the kitchen. Understand "dog" as the water bowl. The clueless-name of the water bowl is "water bowl". Understand "metal" as the water bowl. The aware-name of the water bowl is "coolant reservoir". The clueless-description of the water bowl is "A simple metal bowl labeled [quotation mark]water[quotation mark]. [emptyness of the water bowl]." The aware-description of the water bowl is "A titanium stanchion with hoses and connectors. Engraved on the upright support is the word [quotation mark]coolant transfer coupling[quotation mark]. [emptyness of the water bowl]." The water bowl-proxy is an aware-proxy that is part of the water bowl. Understand "coolant", "line", "transfer", "coupling", "stanchion", "titanium", "hose", "hoses",  "connector", or "connectors" as the water bowl-proxy. The scent of the water bowl is "just slightly less unpleasant than Rover's food bowl". The texture of the water bowl is "cool to the touch".

The food bowl is a bowl in the kitchen. Understand "dog" as the food bowl. The clueless-name of the food bowl is "food bowl". The aware-name of the food bowl is "fuel reservoir". The clueless-description of the food bowl is "A simple metal bowl. It is identical to the water bowl, except for the word [quotation mark]food[quotation mark] that appears on its side. [emptyness  of the food bowl]." The aware-description of the food bowl is "A heavily shielded thermal isotope delivery device. [emptyness of the food bowl]". The food bowl-proxy is an aware-proxy that is part of the food bowl. Understand "fuel", "reservoir", "delivery", or "device" as the food bowl-proxy. The scent of the food bowl is "[food bowl-whiff]". The texture of the food bowl is "smooth and cool".
...
The clueless-name of the shower walls is "walls". The shower walls are privately-named. The aware-name of the shower walls is "fluidics network". The clueless-description of the shower walls is "The walls of the shower are made of slick white plastic. Two buttons are on the wall, one marked [quotation mark]soap[quotation mark] and the other, [quotation mark]shampoo[quotation mark]." The aware-description of the shower walls is "A distribution network of tubes, pumps, and valves that runs throughout the ship, just under the outer hull." The shower walls-proxy is an aware-proxy that is part of the shower walls. Understand "wall", "walls", "fluidics", "network" , "tubes", "valves" or "pumps" as the shower walls-proxy. The scent of the shower walls is "of soap, shampoo, and chlorine". The texture of the shower walls is "smooth and a little slippery".
...
Instead of pushing or touching the soap button:
	...
	otherwise:
		if the player is clueless:
			change the outcome-override to force-success;
			if the First Sim is happening:
				say "A stream of hot, pearlescent white soap is ejected forcefully from the throbbing button, and pools in your hand. You rub it over1 your entire body with wanton abandon and then rinse it off.";
			otherwise:
...
divotsSome divots are scenery in the dug-up field. The printed name of the divots is "holes". Understand "hole", "holes", "excavation", or "excavations" as divots.  The description of the divots is "An apparently haphazard pattern of excavated holes in the ground. None of them are very impressive." The scent of the divots is "like the ground, just more so". The aware-name of the divots is "excavations". The texture of the divots is "not very deep".
...
The Strange Porch is west of the Featureless Desert. The printed name of the the featureless desert is "The Park". The description of the Strange Porch is "You are right outside a dilapidated shack, which has clearly been neglected[inconsequential outside detail]." The scent of the Strange Porch is "metallic, like when you lick aluminum foil".
...
Instead of taking the canned food:
	say "You consider taking the canned food, and maybe saving it for some special occaoccasionsion. On second thought, you eat it. Delayed gratification has never been your strong suit. [run paragraph on]";
...
"spatial manifold" or "manifold attenuator" or "spatial manifold attenuator" or "attenuator"		"The spatial manifold attenuator smoothes irregularities in the Casimir gradient, ensuring pseudolaminar flow in the pathway of the ship through time-space."
...
"mf" or "magnofluctator" or "toggle"		"The magnofluctatron toggle is employed after Casimir hops to null the gamma time function through generation of inversely phased magnoflucatrons. Typically, the toggle is employed 1-3 times as hops are refined from coarse to hyperfine granularity."
...
"magnetic bottle"		"Heavy helium is ionized and confined within a magnetic bottle during the fusion reaction that powers the landing retros. The magnetic bottle is shielded to avoid interference with neighboring structures in the engineering section."
...
"fuel reservoir" or "fuel delivery device"		"For extended missions, ROVER is powered by a thermoisotope generator fed by an expedited hadron destabilizer. The fuel of choice for ROVER is polonium 210, although other isotopes can be substituted at the cost of some conversion efficiency."
...
"fuel vault" or "fuel storage" or "vault"		"The radioisotope fuel for ROVER is contained in a shielded vault on the engineering deck. Access to the vault is under the control of the ACU."
...
"token dispenser" or "token generator"		"The token generator dispenses reward tokens that authenticate within ROVER's neural net and reinforce associated pathways. The generator is closely linked to the ACU and under its control."
...
"flight console" or "flight control console"		"The flight console is normally under the control of the acu. All avionics and astrogation route through the console. Consequently, it controls ship orientation and propulsion in both space and atmospheric flight."
...
"pit scrubber" or "nanobot" or "nanobots" or "hive"		"The polyduramide skin of the ship is often pitted by microscopic material and sometimes by larger bits of matter, resulting in damage to both the skin and the underlying neoadamite hull. The ship is equipped with a nanobot hive and a distribution system capable of covering the ship with pit-scrubbing nanobots in seconds. These nanobots are programmed to reorganize the hull materials, essentially healing the damage. The nanobots will also convert any foreign material they encounter to additional nanobots and/or energy sources, as needed."
...
"retro assembly"		"The retro assembly converts electrical power derived from fusion-charged ultracaps into the ship's ion drive. Within the retro assembly, plasma is supercharged and accelerated, concentrated, and shaped to provide thrust for the ship during planetary landings and takeoffs."
...
"plasma constrictor"		"Reconfigurable superconducting magnets form the magnetic knots within the plasma constrictor, which both store energy and prepare the plasma for injection in the the thrust aperture."
"plasma constrictor hatch" or "plasma constrictor lid"		"The plasma constrictor isolates the magnetic knots and plasma and maintains recirculation until the thrust aperture is triggered."
"thrust aperture" or "thruster aperture"		"The thrust aperapertureture employs a caterpillar pulse magnet to impel the recoiling plasma from the plasma constrictor and into the primary thrusters. The thrust aperture can dilate or constrict, limiting the plasma flow rate to the thruster."
"thruster linkage servo" or "thruster servo" or "thruster linkage"		"A critical servo linkage is employed between the thruster actuation relay and thrust aperture to guard against unintentional tripping of the aperture. The field-networked automata linkage is heavily fortified against Casimir distortion."
...
When Walkies ends:
	...
	if Rover carries the delicious bone:
		...
		say "Rover wags his tails and gnaws on his bone.[paragraph break]You rub his head, distantly, as strange thoughts sweep through your consciousness. You wonder what would happen if the Valkyrie mission failed. What if, during the landing sequence, the ship were buffeted by the planet's particulate matter being torn away by the immense gravity of its star? In that case, critical systems might be damaged. Systems like the relatively fragile ansible antenna. There is no backup ansible antenna. How would the ACU cope with a situation like that? The ACU was designed for a lot of contingencies, but not that one. What would you do? What would you do if you were the ACU?[paragraph break]Your glance falls on your flight suit, and suddenly the question is no longer rhetorical.";
		try reorienting;
	otherwise:
...
To say nobody home:
	if the underling is in the location:
		...
		say "[quotation mark]We told them to stay out of your way. They're probably hiding. Holed up in escape pods or something.[quotation mark][paragraph break][quotation mark]I don't think so sir. When I say nobody, I mean, I've been through just about the entire ship, nose cone to main thruster, and I see no one at all. And another thing -- there aren't any escape pods. Also, no galley, no barracks, nothing. This is like a ghost ship. Creepy.[quotation mark][paragraph break][quotation mark]Get ahold of yourself, [underling]! Secure the cargo door and finish the memory dump, and we can all go home.[quotation mark][paragraph break][quotation mark]Aye sir. Almost done.[quotation mark]"
...
4			"Captain, your failure to communicate only strengthens my case that your ship is derelict. If you will not answer, I suggest to your crew that you are conducting yourself according to spacefaring standards, and that you be relieved of duty. I will accept surrender from any acting captain of your vessel. Do you surrender, Valkyrie?"		"Your ship is bigger than most, but you should see how fast our maintenance droid works. I've seen him strip a colony ship to nuts and bolts in less than an hour. Gah, you gotta love technology."		"I haven't hauled in an [apostrophe]enemy vessel[apostrophe] since the end of the Martian Revolt. Or, I suppose you'd call that the Independence War. A fat lot of good that did you."
