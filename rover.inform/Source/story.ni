...
After touching something (called the item):
	if the texture of the item is not "":
		let the regverb be "feel";
		say "The [item] [the regverb in correct agreement] [texture of the item]."
...
The bathroom floor is privately-named scenery in the bathroom.  Understand "floor", "glass", "ground" or "micropore" as the bathroom floor. The clueless-name of the bathroom floor is "bathroom floor". The aware-name of the bathroom floor is "decking". The clueless-description of the bathroom floor is "The black bathroom floor sparkles thanks to microscopic bits of volcanic glass which assure that the floor is never slippery, even when wet. The micropores in the floor also assure that water does not collect for long on the bathroom floor." The aware-description of the bathroom floor is "The deck plating in the flight deck is painted bright yellow." The bathroom floor-proxy is an aware-proxy that is part of the bathroom floor. Understand "yellow", "deck", "plating", or "decking" as the bathroom floor-proxy. The scent of the bathroom floor is "damp, but not moldy".

The bathroom walls are privately-named scenery in the bathroom.  Understand "walls" or "wall" as the bathroom walls. The mirror is part of the bathroom walls.  The black plate is a device which is part of the bathroom walls. Understand "wall" as bathroom walls. The scent of the bathroom walls is "slightly of chlorine".
...
The clueless-name of the bathroom ceiling is "bathroom ceiling". Understand "ceiling" or "roof" as the bathroom ceiling. The aware-name of the bathroom ceiling is "canopy". The clueless-description of the bathroom ceiling is "The bathroom ceiling is slightly concave to promote drainage towards the walls. A heat lamp is mounted in the center of the ceiling." The aware-description of the bathroom ceiling is "The roof of the flight control section is the nose of the ship, containing the RCS thrusters and the equipment that secretes the ablative coating that protects the ship during planetary landings." The bathroom ceiling-proxy is an aware-proxy which is part of the bathroom ceiling. Understand "canopy" or "nose" as the bathroom ceiling-proxy. The scent of the bathroom ceiling is "like the walls, you would think".

The clueless-name of the irradiator is the "heat lamp". The aware-name of the irradiator is "UV emitter". The clueless-description of the irradiator is "The fresnel lens of a heat lamp is mounted at the apex of the bathroom ceiling." The aware-description of the irradiator is "A series of light-emitting fibers that run through the extruder system. The fibers are [if the irradiator is switched on]energized[otherwise]powered down[end if] at present."  Understand "heat", "lamp", "fresnel", "lens", "heater" or "dryer" as irradiator. The irradiator can be buggy or patched. The irradiator is buggy. The irradiator-proxy is an aware-proxy which is part of the irradiator. Understand "UV", "ultraviolet", "fiber", "fibers", "emitter", "emitters" or "light" as the irradiator-proxy. The scent of the irradiator is "like the bathroom ceiling, you would think".

The clueless-name of the black plate is the "black plate". Understand "glass" or "obsidian" as the black plate. The black plate is switched off. The aware-name of the black plate is "irradiator switch". The clueless-description of the black plate is "A glossy black plate that is just to the right of the bathroom mirror." The aware-description of the black plate is "The relay circuit that actuates the UV emitter in the enamel polymerization system." The black plate-proxy is an aware-proxy which is part of the black plate. Understand "irradiator", "switch", "control", "relay", "circuit" or "actuator" as the black plate-proxy. The scent of the black plate is "slightly of ozone".
...
The clueless-name of the toilet bowl is the "toilet bowl". The aware-name of the toilet bowl is the "reaction chamber".  The clueless-description of the toilet bowl is "The white porcelain bowl is the bottom part of the toilet. [throne status]." The aware-description of the toilet bowl is "The fusion output mixes with reactant in the glossy white chamber at the bottom of the retro assembly, just distal to the thrust aperature. [throne status]." The toilet bowl-proxy is an aware-proxy that is part of the toilet bowl. Understand "reaction" and "chamber" as the toilet bowl-proxy. The scent of the toilet bowl is "[one of]much like you might expect it would, which should teach you not to go around smelling toilet bowls in the future[or]just like it did last time. Yech[or]even worse than you remember it[or]unpleasant, and yet somehow addictive. For you at least. Go figure[stopping]".
...
The clueless-name of the shower walls is "walls". The shower walls are privately-named. The aware-name of the shower walls is "fluidics network". The clueless-description of the shower walls is "The walls of the shower are made of slick white plastic. Two buttons are on the wall, one marked [quotation mark]soap[quotation mark] and the other, [quotation mark]shampoo[quotation mark]." The aware-description of the shower walls is "A distribution network of tubes, pumps and valves that runs throughout the ship, just under the outer hull." The shower walls-proxy is an aware-proxy that is part of the shower walls. Understand "wall", "walls", "fluidics", "network" , "tubes", "valves" or "pumps" as the shower walls-proxy. The scent of the shower walls is "of soap, shampoo and chlorine".
...
The battleship is in Limbo. The battleship is scenery. The description of the battleship is "A long, mirror-surfaced ship similar in profile to the Valkyrie, but smaller. The bow of the ship is ringed with shallow furrows that penetrate the hull, and a similar series of rear-facing furrows are present around the ship's center. Where the Valkyrie has thin struts that supported the outrigged Casimir Drive, this ship has a solid black ring. You estimate that the ship is spinning fast enough to give the the surface of its inner hull about 1g of centripetal accleration. When its ventral surface rotates towards you, you can see not only the standard of the Republic of Mars, but the shield and sickle insignia of the Martian Space Force." Understand "bogdanov" and "starship" as the battleship.
...
"female dog" or "bitch" or "bulldozer" or "the female dog" or "the other dog" or "the bitch" or "the bulldozer"		"robot from Earth"		0	0	0	--		"Janet answers, [quotation mark]We believe that the Myomita ship was configured similarly to the Valkyrie, presumably because they had the same mission. It sounds like their robotic bulldozer was much less advanced that good [apostrophe]ol ROVER.[quotation mark]"		"Janet surmises that the bulldozer was designed to play the same role as ROVER -- recovery of the space probe"		"You tell David and Janet about Rover's discovery of a robotic counterpart, and of his amorous advances towards the bulldozer.[paragraph break]Oh,[quotation mark] she gushes, [quotation mark]that's so cute. I wish she had been nicer to him. He's such a good doggie![quotation mark][paragraph break]David stares at the ceiling."
