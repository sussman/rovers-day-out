...
17			living room	--						front door		"[The underling] fiddles with the controls on the front door, and suddenly you realize that you can no longer feel the door. It is still there, but you can no longer open and close it.[paragraph break][quotation mark]This is [underling] reporting: Cargo bay door secured.[quotation mark][paragraph break]You experience a visceral wave of dread as [the underling] turns toward your deep memory unit, which stores the encrypted data from the Musashi 5 space probe.[paragraph break]You vainly wish that you had some control of the situation, that you were not paralyzed and immobile. You float disembodied  in a sea of anxiety."
