...
The water bowl is a bowl in the kitchen. Understand "dog" as the water bowl. The clueless-name of the water bowl is "water bowl". Understand "metal" as the water bowl. The aware-name of the water bowl is "coolant reservoir". The clueless-description of the water bowl is "A simple metal bowl labeled [quotation mark]water[quotation mark]. [emptiness of the water bowl]." The aware-description of the water bowl is "A titanium stanchion with hoses and connectors. Engraved on the upright support is the word [quotation mark]coolant transfer coupling[quotation mark]. [emptiness of the water bowl]." The water bowl-proxy is an aware-proxy that is part of the water bowl. Understand "coolant", "line", "transfer", "coupling", "stanchion", "titanium", "hose", "hoses",  "connector", or "connectors" as the water bowl-proxy. The scent of the water bowl is "just slightly less unpleasant than Rover's food bowl". The texture of the water bowl is "cool to the touch".
...
"plasma constrictor"		"Reconfigurable superconducting magnets form the magnetic knots within the plasma constrictor, which both store energy and prepare the plasma for injection in the thrust aperture."
...
To say nobody home:
	if the underling is in the location:
		...
		say "[quotation mark]We told them to stay out of your way. They're probably hiding. Holed up in escape pods or something.[quotation mark][paragraph break][quotation mark]I don't think so sir. When I say nobody, I mean, I've been through just about the entire ship, nose cone to main thruster, and I see no one at all. And another thing -- there aren't any escape pods. Also, no galley, no barracks, nothing. This is like a ghost ship. Creepy.[quotation mark][paragraph break][quotation mark]Get a hold of yourself, [underling]! Secure the cargo door and finish the memory dump, and we can all go home.[quotation mark][paragraph break][quotation mark]Aye sir. Almost done.[quotation mark]"
